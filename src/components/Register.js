...
function Register() {
  ...
  return (
    <section className="authentication" aria-label="Регистрация">
      ...
      <p className='authentication__subtitle'>Уже зарегистрированы? <Link to="/sign-in" className="authentication__subtitle authentication__subtitle_type_link">Войти</Link></p>
    </section>
  )
}
